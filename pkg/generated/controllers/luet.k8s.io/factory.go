...
import (
	...
	informers "github.com/mudler/luet-k8s/pkg/generated/informers/externalversions"
...
func (c *Factory) Luet() Interface {
	return New(c.controllerManager, c.informerFactory.Luet(), c.clientset)
}
